...
`;var ui_modal_decorate=function(decorators,target,key,desc){var d,c=arguments.length,r=c<3?target:null===desc?desc=Object.getOwnPropertyDescriptor(target,key):desc;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(decorators,target,key,desc);else for(var i=decorators.length-1;i>=0;i--)(d=decorators[i])&&(r=(c<3?d(r):c>3?d(target,key,r):d(target,key))||r);return c>3&&r&&Object.defineProperty(target,key,r),r};let UiModal=class UiModal extends lit.WF{constructor(){super(...arguments),this.open=!1,this.title="",this.handleKeyDown=e=>{"Escape"===e.key&&this.open&&this.close()}}static{this.styles=ui_modal_styles_styles}connectedCallback(){super.connectedCallback(),document.addEventListener("keydown",this.handleKeyDown)}disconnectedCallback(){document.removeEventListener("keydown",this.handleKeyDown),super.disconnectedCallback()}handleOverlayClick(e){e.target===this&&this.close()}close(){this.dispatchEvent(new CustomEvent("close")),this.open=!1}render(){return lit.qy`
      <div 
