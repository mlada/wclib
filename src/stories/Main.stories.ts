...
const Template = () => html`
  <ui-header style="--header-height: 80px;">
   ...
   <ui-card
    ...
    <ui-card style="display: block;margin-top:180px;margin-bottom:180px"
      size='large'
      type='horizontal'
    ...
    <h3>Создание эффективного онлайн-представительства с индивидуальным дизайном и современными технологиями</h3>
    ...
    <div class="colored-block">
      <ui-card  
        ...
        <div class="centered" slot="content" >
          <ui-button type="light" size="large" label="Рассчитать стоимость"></ui-button>        
        </div>
      </ui-card>
    </div>
