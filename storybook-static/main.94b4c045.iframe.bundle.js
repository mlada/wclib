...
`;var ui_header_decorate=function(decorators,target,key,desc){var d,c=arguments.length,r=c<3?target:null===desc?desc=Object.getOwnPropertyDescriptor(target,key):desc;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(decorators,target,key,desc);else for(var i=decorators.length-1;i>=0;i--)(d=decorators[i])&&(r=(c<3?d(r):c>3?d(target,key,r):d(target,key))||r);return c>3&&r&&Object.defineProperty(target,key,r),r};let UiHeader=class UiHeader extends lit.WF{constructor(){super(...arguments),this.scrollHandler=()=>{const header=this.shadowRoot?.querySelector(".ui-header");header&&(window.scrollY>10?header.classList.add("scrolled"):header.classList.remove("scrolled"))}}static{this.styles=ui_header_styles_styles}connectedCallback(){super.connectedCallback(),window.addEventListener("scroll",this.scrollHandler)}disconnectedCallback(){window.removeEventListener("scroll",this.scrollHandler),super.disconnectedCallback()}render(){return lit.qy`
...
`;var ui_menu_decorate=function(decorators,target,key,desc){var d,c=arguments.length,r=c<3?target:null===desc?desc=Object.getOwnPropertyDescriptor(target,key):desc;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(decorators,target,key,desc);else for(var i=decorators.length-1;i>=0;i--)(d=decorators[i])&&(r=(c<3?d(r):c>3?d(target,key,r):d(target,key))||r);return c>3&&r&&Object.defineProperty(target,key,r),r};let UiMenu=class UiMenu extends lit.WF{static{this.styles=ui_menu_styles_styles}#elements_accessor_storage=[];get elements(){return this.#elements_accessor_storage}set elements(value){this.#elements_accessor_storage=value}#type_accessor_storage="horizontal";get type(){return this.#type_accessor_storage}set type(value){this.#type_accessor_storage=value}#size_accessor_storage="medium";get size(){return this.#size_accessor_storage}set size(value){this.#size_accessor_storage=value}render(){return lit.qy`
